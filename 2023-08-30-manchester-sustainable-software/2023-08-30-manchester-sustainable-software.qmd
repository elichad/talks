...
![](images/university_of_birmingham_logo.png)
![](images/ukri-stfc-square-logo.png)
![](images/SSI_PRIMARY_LOGO.svg)
...
![](images/rse_logo.png){width="30%" fig-align="center"}
...
**Sustainable software** is software which is: ^[[Defining Software Sustainability](https://danielskatzblog.wordpress.com/2016/09/13/defining-software-sustainability/) by Daniel S. Katz]
...
Would you use and trust the results of a microscope or telescope that hadn’t been built by qualified engineers or tested? ^[[Better Software, Better Research](https://www.software.ac.uk/resources/publications/better-software-better-research)]

. . .

Software is the most prevalent of all the instruments used in modern science

* 84% of scientists say developing scientific software is important for their own research ^[[How do scientists develop and use scientific software?](https://dl.acm.org/doi/10.1109/SECSE.2009.5069155)]
* But most have learned through self-study, and this leaves gaps
* Only 47% have a good understanding of testing

## Why Go to All This Effort?

The consequences of *not* following best practices can be massive

* A software bug led to the retraction of three Science papers
 ^[[A Scientist's Nightmare: Software Problem Leads to Five Retractions](https://www.science.org/doi/10.1126/science.314.5807.1856)]
...
:::{.incremental}
* They put their code on GitHub, but don't update it often
* Their code diverges as they each study a different telescope
...
* The code is difficult to understand and use
    * Replicating the results is extremely challenging
* The code for the telescope models cannot be applied to other types of astronomical event, even though the maths is generalised
    * A later student must start from scratch
* The code was never reviewed for bugs
    * The results could have contained major errors
...
* Originally developed by a single researcher for use in his group
    * "while I tried to make it flexible from the outset, it morphed a bit over time and I reached a ceiling of what I could do myself" ^[[Magnetic imaging software now FABBERlously easy to use](https://www.software.ac.uk/blog/2016-09-26-magnetic-imaging-software-now-fabberlously-easy-use)]
...
::: {.column width="40%"}
![Image © James Clear](images/tiny-gains-graph.jpg){fig-alt="The aggregation of marginal gains shows how small improvements and one percent gains compound."}
:::
...
![](images/little_and_often_commits.png){width=70%}
...
![](images/example_test.png){fig-align="center"}
...
![](images/example_modular_unit.png){fig-align="center"}
...
![](images/example_code_review.png){fig-align="center" width="70%"}
...
:::{.r-stack}
![](images/example_ci.png){fig-align="center" width=80%}
:::
...
* Research Software Engineering is a real and viable career path (that you may already be following)
