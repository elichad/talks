...
* Occasionally I encounter talks and discussions on 'software ergonomics,' 'software usability,' etc.
* These tread the same ground, but rarely mention disability

. . .

* I want to bring back the disability justice angle
* There is a great wealth of accessibility expertise in industry that we as RSEs can learn from
-->
<!--- 
---
...
Other numeronyms: i18n (internationalisation), P2P (peer-to-peer), K9 (canine)
...
* Ask: are there barriers in the _development process_ that would prevent some disabled people from contributing?
:::
